        ...
        <FieldGroup>
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Field>
              ...
              />
              <FieldDescription>
                Permanent identifier. Changing it breaks anything referring to
                the old value.
              </FieldDescription>
        ...
        <FieldGroup>
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <Field>
              ...
              />
              <FieldDescription>Empty = not offered yearly.</FieldDescription>
            </Field>
          </div>
        ...
        <FieldGroup>
          ...
          <div>
            <p className="text-muted-foreground mb-2 text-xs font-medium">
              Included on every tier today — untick to sell a tier without one.
            </p>
            <div className="grid gap-1 sm:grid-cols-2">
              {Object.entries(BASELINE_FEATURE_LABELS).map(([key, label]) => (
                <ToggleField
                  key={key}
                  name={key}
                  label={label}
